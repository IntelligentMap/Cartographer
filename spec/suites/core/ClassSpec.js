describe("Class", function () {
	...
	describe("#extend", function () {
		...
		beforeEach(function () {
			...
			Klass = Cartographer.Class.extend({
				statics: {bla: 1},
				includes: {mixin: true},
		...
		it("includes multiple mixins", function () {
			var Klass2 = Cartographer.Class.extend({
		...
		it("merges options instead of replacing them", function () {
			var KlassWithOptions1 = Cartographer.Class.extend({
				options: {
					foo1: 1,
					foo2: 2
				}
		...
		it("gives new classes a distinct options object", function () {
			var K1 = Cartographer.Class.extend({options: {}});
			var K2 = K1.extend({});
